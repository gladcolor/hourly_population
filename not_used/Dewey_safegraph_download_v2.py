...
save_dir = r'K:\SafeGraph\Advan_2024_API\Weekly_Patterns'
# save_dir = r'D:\SafeGraph\Advan_2024_API\Weekly_Patterns'    # Lenova 2018
# save_dir = r'E:\SafeGraph\Advan_2024_API\Weekly_Patterns'   #２０１８
    ...
    while current_page <= total_pages:
        ...
        results = requests.get(url=PRODUCT_API_PATH,
                                   params={'page': current_page,
                                           'partition_key_after':  '2023-01-01',   # optionally set date value here
