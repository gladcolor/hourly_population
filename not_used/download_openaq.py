...
save_dir = r'F:\Research\Wild_fire\OpenAQ'
                ...
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        with open(fname, 'wb') as f:
                            ...
                            print(f"Location: {id}, {processed_cnt}/{total_cnt})", f"Day: {year:04}-{month:02}-{day:02}, Location: {id}, Downloaded: {url}")
                    else:
...
if __name__ == '__main__':
    ...
    location_list_mp = mp.Manager().list(location_df.iloc[10640:]['id'].tolist())
    process_cnt = 6
